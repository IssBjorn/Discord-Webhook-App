...
class TextPickerView extends Ui.View {
    ...
    static const INPUT_LETTERS = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_ !@,.#()£$? \n";  // valid characters for input
...
class TextPickerDelegate extends Ui.BehaviorDelegate {
    ...
    function onSelect() {
        if (picker.input_chars.substring(picker.charIdx,picker.charIdx+1).equals("*")) {
            ...
            App.Properties.setValue("content", inputStr + newStr);
            ...
            Ui.pushView(new DiscordWebhookView(), new DiscordWebhookDelegate(), WatchUi.SLIDE_UP);
