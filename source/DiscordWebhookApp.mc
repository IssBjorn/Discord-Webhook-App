...
class DiscordWebhookApp extends Application.AppBase {
    ...
    Application.Properties.setValue("content","");
    Application.Properties.setValue("webhookUrl","");
    }
...
class TextPickerSampleInput extends WatchUi.BehaviorDelegate {
    ...
    function onSelect() {
        if (!$.gWidgetStarted) {
            $.gWidgetStarted = true;
            var view = new TextPickerView("  DISCORD","Message:",4,6,"");
